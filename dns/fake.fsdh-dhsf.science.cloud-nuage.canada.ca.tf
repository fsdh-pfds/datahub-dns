//fake_fsdh-dhsf_science_cloud-nuage_canada_ca.tf
resource "azurerm_dns_zone" "fake_fsdh-dhsf_science_cloud-nuage_canada_ca-zone" {
  name                = "fake_fsdh-dhsf_science_cloud-nuage_canada_ca"
  resource_group_name = var.resource_group_name
}

resource "azurerm_dns_a_record" "fake_fsdh-dhsf_science_cloud-nuage_canada_ca-at" {
  name                = "@"
